        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Feight = table.Column<float>(type: "real", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, "Enim Etiam Corp" },
                    { 2, "Facilisis Vitae Orci LLC" },
                    { 3, "Fringilla Ornare Associates" },
                    { 4, "Primis In Faucibus Consulting" },
                    { 5, "Suspendisse Associates" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 4, "Hendrerit Donec", 0.62, 20, 0.5 },
                    { 2, 2, "Euismod In Dolor Foundation", 0.39000000000000001, 12, 0.5 },
                    { 3, 4, "Faucibus Morbi Vehicula Industries", 12.43, 8, 0.5 },
                    { 4, 3, "Magnis LLC", 9.8000000000000007, 18, 0.5 },
                    { 5, 1, "Ante Inc.", 15.9, 5, 0.5 },
                    { 6, 1, "Curabitur Dictum Associates", 19.170000000000002, 5, 0.5 },
                    { 7, 2, "Adipiscing Non Luctus Industries", 9.9800000000000004, 17, 0.5 },
                    { 8, 1, "Magna Nec Quam PC", 16.309999999999999, 19, 0.5 },
                    { 9, 1, "Est Nunc Institute", 18.100000000000001, 13, 0.5 },
                    { 10, 3, "Egestas Sed Pharetra Foundation", 12.289999999999999, 1, 0.5 },
                    { 11, 3, "Donec Est Institute", 19.829999999999998, 11, 0.5 },
                    { 12, 5, "Nunc Limited", 10.77, 15, 0.5 },
                    { 13, 3, "Tincidunt Corp.", 15.220000000000001, 5, 0.5 },
                    { 14, 3, "Nec Mauris Inc.", 12.539999999999999, 8, 0.5 },
                    { 15, 3, "Risus A Industries", 11.210000000000001, 6, 0.5 }
                });
